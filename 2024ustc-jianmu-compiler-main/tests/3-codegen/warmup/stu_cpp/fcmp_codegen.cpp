...
void translate_main(CodeGen *codegen) {
    ...
    codegen->append_inst("bcnez $fcc0, .out1");
    codegen->append_inst("addi.w $t0, $zero, 0");
    codegen->append_inst("b .target");
    codegen->append_inst(".out1", ASMInstruction::Label);
    codegen->append_inst("addi.w $t0, $zero, 1"); 
    codegen->append_inst(".target", ASMInstruction::Label);       
    ...
    codegen->append_inst("nor $t0, $t0, $zero");
