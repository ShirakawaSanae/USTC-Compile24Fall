...
void translate_main(CodeGen *codegen) {
    ...
    offset_map["%op0"] = -24;  // TODO: 请填空 float 16 + 8
    offset_map["*%op0"] = -32; // TODO: 请填空 ptr 24 + 8
    ...
    // %op1 对应的内存空间中
    offset_map["%op1"] = -40; // TODO: 请填空 32 + 8
    codegen->append_inst("ld.d",
                         {"$t0", "$fp", std::to_string(offset_map["%op0"])});
