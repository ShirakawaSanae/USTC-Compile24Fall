...
void translate_callee(CodeGen *codegen) {
    ...
    // 为参数分配空间
    offset_map["%arg0"] = -20; // TODO: 请填空 也是 i32 -> 16 + 4
    ...
    offset_map["%op1"] = -28;  // TODO: 请填空 20 + 8 
    offset_map["*%op1"] = -32; // TODO: 请填空 i32, 36 - 4
    ...
    offset_map["%op2"] = -36; // TODO: 请填空 40 - 4
    codegen->append_inst("ld.d",
                         {"$t0", "$fp", std::to_string(offset_map["%op1"])});
    ...
    offset_map["%op3"] = -40; // TODO: 请填空 44 - 4
    codegen->append_inst("ld.w",
